...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_miryoku(
    ...
    U_NP,              U_NP,              LT(FUN, KC_DEL),   LT(NUM, KC_BSPC),  LT(SYM, KC_ENT),   LT(MOUSE, KC_TAB), LT(NAV, KC_SPC),   LT(MEDIA, KC_ESC), U_NP,              U_NP
  #elif defined MIRYOKU_ALPHAS_QGMLWB
    KC_Q,              KC_G,              KC_M,              KC_L,              KC_W,              KC_B,              KC_Y,              KC_U,              KC_V,              KC_QUOT,
    LGUI_T(KC_D),      LALT_T(KC_S),      LCTL_T(KC_T),      LSFT_T(KC_N),      KC_R,              KC_I,              LSFT_T(KC_A),      LCTL_T(KC_E),      LALT_T(KC_O),      LGUI_T(KC_H),
    LT(BUTTON, KC_Z),  ALGR_T(KC_X),      KC_C,              KC_F,              KC_J,              KC_K,              KC_P,              KC_COMM,           ALGR_T(KC_DOT),    LT(BUTTON, KC_SLSH),
    U_NP,              U_NP,              LT(FUN, KC_DEL),   LT(NUM, KC_BSPC),  LT(SYM, KC_ENT),   LT(MOUSE, KC_TAB), LT(NAV, KC_SPC),   LT(MEDIA, KC_ESC), U_NP,              U_NP
  #else
    KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,
